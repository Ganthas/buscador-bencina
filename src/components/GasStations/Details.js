...
const Details = ({ distribuidor, direccion_calle, direccion_numero, precios, ubicacion }) => {
    ...
    // splice: recorta los últimos 3 elementos del largo y luego te retorna esos mismos
    // slice:  te define el arreglo con un inicio y fin
